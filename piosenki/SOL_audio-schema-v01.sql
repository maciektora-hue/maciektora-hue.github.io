-- SOL — audio schema V1
-- Addytywna migracja dla:
--   1) audio
--   2) audio_middle_end
--   3) audio_feature_snapshots
--
-- Źródło cech: audio_features_v08.csv
-- 191 kolumn łącznie:
--   6 pól pliku -> audio
--   185 pól konfiguracji i cech -> audio_feature_snapshots
--
-- Bez DROP. Bez modyfikacji istniejących tabel.
